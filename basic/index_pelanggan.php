            ...
            <table>
              ...
              <?php
                ...
                while($data = mysqli_fetch_array($query)){
                  ...
                  echo "<td>";
                  echo "<a href='update_pelanggan.php?no_pelanggan=".$data['no_pelanggan']."'><button class ='button btn'>Edit</button></a>";
                  echo "</td>";
                  echo "<td>";
                  echo "<a href='delete_pelanggan.php?no_pelanggan=".$data['no_pelanggan']."'><button class ='button btn'>Delete</button></a>";
                  echo "</td>";
                  echo "</tr>";
                }
              ?>
