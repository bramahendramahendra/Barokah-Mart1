            ...
            <table>
              ...
              <?php
                ...
                while($data = mysqli_fetch_array($query)){
                  ...
                  echo "<td>";
                  echo "<a href='update_produk.php?kode_barang=".$data['kode_barang']."'><button class ='button btn'>Edit</button></a>";
                  echo "</td>";
                  echo "<td>";
                  echo "<a href='delete_produk.php?kode_barang=".$data['kode_barang']."'><button class ='button btn'>Delete</button></a>";
                  echo "</td>";
                  echo "</tr>";
                }
              ?>
